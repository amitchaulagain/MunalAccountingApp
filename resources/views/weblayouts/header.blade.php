...
<nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light fixed-top" id="ftco-navbar">
        ...
        <div class="collapse navbar-collapse" id="ftco-nav">
            <ul class="navbar-nav m-auto">
                ...
                <li class="nav-item"><a href="/resources" class="nav-link"><span style="color: orange">Calculator</span>
                        <svg color="orange" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-calculator" viewBox="0 0 16 16">
                ...
                <li class="nav-item"><a href="/contactus" class="nav-link"><span style="color: orange">Talk Now</span>
                        ...
                        <svg color="orange" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-telephone" viewBox="0 0 16 16">
    ...
    <div id="overlay1">
        <div class="overlay-item-box">
            <div class="row">
                <div class="col-md-1">
                    <svg color="orange" xmlns="http://www.w3.org/2000/svg" width="50" height="50" fill="currentColor" class="bi bi-person-workspace" viewBox="0 0 16 16">
                ...
                <div style="top:-14px;" class="col-md-6 hovered-text">
                   <h3>Book with your local office</h3></a>
        ...
        <div class="overlay-item-box">
            <div class="row">
                <div class="col-md-1">
                    <svg color="orange" xmlns="http://www.w3.org/2000/svg" width="50" height="50" fill="currentColor" class="bi bi-pc-display-horizontal" viewBox="0 0 16 16">
        ...
        <div class="overlay-item-box">
            <div class="row">
                <div class="col-md-1">
                    ...
                    <svg color="orange" xmlns="http://www.w3.org/2000/svg" width="50" height="50" fill="currentColor" class="bi bi-journal-check" viewBox="0 0 16 16">
    ...
    <div id="overlay2">
        ...
        <div class="overlay-item-box">
            ...
            <div class="row">
                <div class="col-md-1">
                    <svg color="orange" xmlns="http://www.w3.org/2000/svg" width="50" height="50" fill="currentColor" class="bi bi-journals" viewBox="0 0 16 16">
    ...
    <div id="overlay3">
        <div class="overlay-item-box">
            <div class="row">
                <div class="col-md-1">
                    <svg color="orange" xmlns="http://www.w3.org/2000/svg" width="50" height="50" fill="currentColor" class="bi bi-cash-coin" viewBox="0 0 16 16">
        ...
        <div class="overlay-item-box">
            <div class="row">
                <div class="col-md-1">
                    <svg color="orange" xmlns="http://www.w3.org/2000/svg" width="50" height="50" fill="currentColor" class="bi bi-calendar-week" viewBox="0 0 16 16">
