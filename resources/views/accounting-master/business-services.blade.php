...
@section('content_box')
    ...
    <section class="ftco-section ftco-no-pt bg-light">
        <div class="row main">
            ...
            <div class="col-md-6">
                <img class="tax-image" src="{{ asset('public/images/uploads/cms/' . $CMS['business_services_image1']) }}" width="500px"
    ...
    <section class="ftco-section ftco-no-pt bg-light">
        <div class="row main">
            <div class="col-md-6">
                <img class="tax-image" src="{{ asset('public/images/uploads/cms/' . $CMS['business_services_image2']) }}" width="500px"
                     height="400px" style="margin-top: 120px;">
            </div>
            <div class="col-md-6 ">
    ...
    <section class="ftco-section ftco-no-pt bg-light">
        <div class="row main">
            ...
            <div class="col-md-6">
                <img class="tax-image" src="{{ asset('public/images/uploads/cms/' . $CMS['business_services_image3']) }}" width="500px"
                     height="400px" style="margin-top: 120px;">
            </div>
        </div>
    </section>
